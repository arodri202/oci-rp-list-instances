""" Temporary (and incomplete) functions client

The official SDK carries a working functions client which should be preferred.
(That version of the SDK is currently in preview.)
"""
# coding: utf-8
...
from oci.core.models import core_type_mapping
missing = Sentinel("Missing")


class FunctionsClient(object):
    """
    API for Functions service.
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("functions", config, signer, core_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')

    def list_apps(self, compartment_id, **kwargs):
        """
        ListApps
        Lists the configured apps.
